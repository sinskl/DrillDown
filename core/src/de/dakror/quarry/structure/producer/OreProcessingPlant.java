 ...
 */
public class OreProcessingPlant extends ProducerStructure {
    public static final ProducerSchema classSchema = new ProducerSchema(0, StructureType.OreProcessingPlant, 4,
            3,
            "crusher",
            new Items(ItemType.Stone, 30, ItemType.SteelIngot, 25, ItemType.SteelPlate, 15, ItemType.Scaffolding, 10),
            new RecipeList() {
                @Override
                protected void init() {
                    // RockCrusher recipes
    ...
    public OreProcessingPlant(int x, int y) {
