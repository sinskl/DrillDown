...
import de.dakror.quarry.structure.producer.OreProcessingPlant;
...
public enum StructureType {
    ...
    OreProcessingPlant(74, OreProcessingPlant.class),
    IngotMold(75, IngotMold.class),
    CharcoalMound(76, CharcoalMound.class),
    Mason(77, Mason.class),
    Boiler(78, Boiler.class),
    WireDrawer(79, WireDrawer.class),
    RollingMachine(80, RollingMachine.class),
    BlastFurnace(81, BlastFurnace.class),
    Condenser(82, Condenser.class),
    Mixer(83, Mixer.class),
    Kiln(84, Kiln.class),
    SawMill(85, SawMill.class),
    TubeBender(86, TubeBender.class),
    Polarizer(87, Polarizer.class),
    Compactor(88, Compactor.class),
    Assembler(89, Assembler.class),
    Refinery(90, Refinery.class),
    DistillationColumn(91, DistillationColumn.class),
    Polymerizer(92, Polymerizer.class),
    Centrifuge(93, Centrifuge.class),
    InjectionMolder(94, InjectionMolder.class),
    Crucible(95, Crucible.class),
    DeviceFabricator(96, DeviceFabricator.class),
    InductionFurnace(97, InductionFurnace.class),
    FillingMachine(98, FillingMachine.class),
    BarrelDrainer(99, BarrelDrainer.class),
    ArcWelder(210, ArcWelder.class),
